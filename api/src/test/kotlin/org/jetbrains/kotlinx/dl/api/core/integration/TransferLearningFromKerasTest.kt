...
class TransferLearningTest : IntegrationTest() {
    ...
    fun loadModelConfigAndWeightsFromKeras() {
        ...
        testModel.use {
            ...
            val conv2DKernelWeights = it.getLayer("conv2d").extractWeights()[0] as Array<Array<Array<FloatArray>>>
            assertEquals(conv2DKernelWeights[0][0][0][0], 0.06445057f)

            val conv2DKernelWeights1 = it.getLayer("conv2d_1").extractWeights()[0] as Array<Array<Array<FloatArray>>>
    ...
    fun loadModelConfigAndWeightsFromKerasAndTrainDenseLayersOnly() {
        ...
        testModel.use {
            ...
            val conv2DKernelWeightsBeforeTraining =
                it.getLayer("conv2d").extractWeights()[0] as Array<Array<Array<FloatArray>>>
            assertEquals(conv2DKernelWeightsBeforeTraining[0][0][0][0], 0.06445057f)

            val denseDKernelWeightsBeforeTraining = it.getLayer("dense").extractWeights()[0] as Array<FloatArray>
            ...
            val denseDKernelWeightsAfterTraining = it.getLayer("dense").extractWeights()[0]
    ...
    fun loadModelConfigAndWeightsPartiallyFromKerasAndTrainDenseLayersOnly() {
        ...
        testModel.use {
            ...
            val denseDKernelWeightsAfterTraining = it.getLayer("dense").extractWeights()[0] as Array<FloatArray>
            assertFalse(denseDKernelWeightsBeforeTraining.contentEquals(denseDKernelWeightsAfterTraining))
