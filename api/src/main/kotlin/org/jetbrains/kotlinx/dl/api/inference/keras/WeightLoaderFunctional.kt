 ...
 */
public fun Functional.loadWeights(
    hdfFile: HdfFile
) {
 ...
 * @param [hdfFile] File in hdf5 file format containing weights of Sequential model.
 */
public fun Functional.loadWeightsForFrozenLayers(
    hdfFile: HdfFile
) {
...
private fun loadWeightsFromHdf5Group(group: Group, model: Functional, layerList: MutableList<Layer>?) {
...
private fun initLayerWeights(it: Layer, model: Functional) {
    when (it::class) {
...
private fun initConv2DVariablesByDefaultInitializer(name: String, model: Functional) {
...
private fun initDepthwiseConv2DVariablesByDefaultInitializer(name: String, model: Functional) {
