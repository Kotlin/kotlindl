 ...
 * @property [strides] Stride of the pooling operation for each dimension of input tensor.
 * NOTE: Specifying stride value != 1 is incompatible with specifying `dilation` value != 1.
 * @property [dilation] Number specifying the dilation rate to use for dilated convolution sequence dimension of input tensor.
...
public class Conv1D(
    ...
    public val strides: Long = 1,
    public val dilation: Long = 1,
    ...
    stridesInternal = longArrayOf(1, 1, strides, 1),
    dilationsInternal = longArrayOf(1, 1, dilation, 1),
