...
public class BatchNorm(
    ...
    override fun build(tf: Ops, kGraph: KGraph, inputShape: Shape) {
        ...
        movingVariance =
            variable(tf, movingVarianceVariableName, weightShape, fanIn, fanOut, movingVarianceInitializer, null)

        if (scale) {
            val gammaVariableName = batchNormGammaVarName(name)
            gamma = variable(tf, gammaVariableName, weightShape, fanIn, fanOut, gammaInitializer, gammaRegularizer)
        }
