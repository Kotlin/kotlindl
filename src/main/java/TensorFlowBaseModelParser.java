 ...
 * Map of input graph nodes (placeholders) and transformers that allow to transform input into tensor.  List of output graph nodes.  Transformer that allows to transform tensors into output.  {@inheritDoc}
...
public abstract class TensorFlowBaseModelParser<I, O> implements ModelParser<I, O, TFModel> {
...
/** {@inheritDoc} *//*
    ...
    @Override public TFModel parse(byte[] mdl) {
