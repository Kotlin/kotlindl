...
/**
 * This examples demonstrates the inference concept on ResNet'50v2 model:
 * - Model configuration, model weights and labels are obtained from [ModelZoo].
 * - Weights are loaded from .h5 file, configuration is loaded from .json file.
 * - Model predicts on a few images located in resources.
 * - Special preprocessing (used in ResNet'50v2 during training on ImageNet dataset) is applied to images before prediction.
 * - No additional training.
 * - No new layers are added.
 */
fun resnet50v2prediction() {
    val modelZoo =
        ModelZoo(commonModelDirectory = File("cache/pretrainedModels"), modelType = Models.TensorFlow.ResNet_50_v2)
...
/** */
fun main(): Unit = resnet50v2prediction()
