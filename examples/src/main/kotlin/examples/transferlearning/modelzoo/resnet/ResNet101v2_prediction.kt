...
/**
 * This examples demonstrates the inference concept on ResNet'101v2 model:
...
fun resnet101v2prediction() {
    val modelHub =
        ModelHub(commonModelDirectory = File("cache/pretrainedModels"), modelType = Models.TensorFlow.ResNet_101_v2)
