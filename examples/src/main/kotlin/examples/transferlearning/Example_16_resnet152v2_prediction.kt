 ...
 */
fun main() {
    val jsonConfigFile = getResNet152v2JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getResNet152v2WeightsFile()
...
private fun getResNet152v2JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet152v2JSONModelPath = properties["resnet152v2JSONModelPath"] as String

    return File(resnet152v2JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getResNet152v2WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet152v2h5WeightsPath = properties["resnet152v2h5WeightsPath"] as String

    return HdfFile(File(resnet152v2h5WeightsPath))
}
