 ...
 */
fun main() {
    val jsonConfigFile = getResNet101JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getResNet101WeightsFile()
...
private fun getResNet101JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet101JSONModelPath = properties["resnet101JSONModelPath"] as String

    return File(resnet101JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getResNet101WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet101h5WeightsPath = properties["resnet101h5WeightsPath"] as String

    return HdfFile(File(resnet101h5WeightsPath))
}
