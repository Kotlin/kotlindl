...
at examples.transferlearning.Example_19_densenet169_predictionKt.main(Example_19_densenet169_prediction.kt:55)
at examples.transferlearning.Example_19_densenet169_predictionKt.main(Example_19_densenet169_prediction.kt)
 */
/**
 ...
 */
fun main() {
    val jsonConfigFile = getdensenet169JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getdensenet169WeightsFile()
...
private fun getdensenet169JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val densenet169JSONModelPath = properties["densenet169JSONModelPath"] as String

    return File(densenet169JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getdensenet169WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val densenet169h5WeightsPath = properties["densenet169h5WeightsPath"] as String

    return HdfFile(File(densenet169h5WeightsPath))
}
