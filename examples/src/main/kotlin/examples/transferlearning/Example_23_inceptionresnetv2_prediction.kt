...
at examples.transferlearning.Example_19_inceptionresnetv2_predictionKt.main(Example_19_inceptionresnetv2_prediction.kt:55)
at examples.transferlearning.Example_19_inceptionresnetv2_predictionKt.main(Example_19_inceptionresnetv2_prediction.kt)
 */
/**
 ...
 */
fun main() {
    val jsonConfigFile = getinceptionresnetv2JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getinceptionresnetv2WeightsFile()
...
private fun getinceptionresnetv2JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val inceptionresnetv2JSONModelPath = properties["inceptionresnetv2JSONModelPath"] as String

    return File(inceptionresnetv2JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getinceptionresnetv2WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val inceptionresnetv2h5WeightsPath = properties["inceptionresnetv2h5WeightsPath"] as String

    return HdfFile(File(inceptionresnetv2h5WeightsPath))
}
