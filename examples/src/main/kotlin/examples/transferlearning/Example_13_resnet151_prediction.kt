 ...
 */
fun main() {
    val jsonConfigFile = getResNet151JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getResNet151WeightsFile()
...
private fun getResNet151JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet151JSONModelPath = properties["resnet151JSONModelPath"] as String

    return File(resnet151JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getResNet151WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val resnet151h5WeightsPath = properties["resnet151h5WeightsPath"] as String

    return HdfFile(File(resnet151h5WeightsPath))
}
