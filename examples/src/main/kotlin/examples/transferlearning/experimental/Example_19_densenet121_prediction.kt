...
at examples.transferlearning.Example_19_densenet121_predictionKt.main(Example_19_densenet121_prediction.kt:55)
at examples.transferlearning.Example_19_densenet121_predictionKt.main(Example_19_densenet121_prediction.kt)
 */
/**
 ...
 */
fun main() {
    val jsonConfigFile = getdensenet121JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getdensenet121WeightsFile()
...
private fun getdensenet121JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val densenet121JSONModelPath = properties["densenet121JSONModelPath"] as String

    return File(densenet121JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getdensenet121WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val densenet121h5WeightsPath = properties["densenet121h5WeightsPath"] as String

    return HdfFile(File(densenet121h5WeightsPath))
}
