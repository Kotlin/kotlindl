...
at examples.transferlearning.Example_19_efficientnetb0_predictionKt.main(Example_19_efficientnetb0_prediction.kt:55)
at examples.transferlearning.Example_19_efficientnetb0_predictionKt.main(Example_19_efficientnetb0_prediction.kt)
 */
/**
 ...
 */
fun main() {
    val jsonConfigFile = getefficientnetb0JSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getefficientnetb0WeightsFile()
...
private fun getefficientnetb0JSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val efficientnetb0JSONModelPath = properties["efficientnetb0JSONModelPath"] as String

    return File(efficientnetb0JSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getefficientnetb0WeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val efficientnetb0h5WeightsPath = properties["efficientnetb0h5WeightsPath"] as String

    return HdfFile(File(efficientnetb0h5WeightsPath))
}
