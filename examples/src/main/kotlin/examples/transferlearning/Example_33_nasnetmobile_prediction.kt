...
// TODO: write about my experience and unhandled enasnetmobile with strange layer names
/**
...
Enasnetmobile in thread "main" java.lang.IllegalArgumentEnasnetmobile: invalid name: 'conv1/conv_conv2d_kernel' does not match the regular expression [A-Za-z0-9.][A-Za-z0-9_.\-]*
...
at examples.transferlearning.Example_19_nasnetmobile_predictionKt.main(Example_19_nasnetmobile_prediction.kt:55)
at examples.transferlearning.Example_19_nasnetmobile_predictionKt.main(Example_19_nasnetmobile_prediction.kt)
 */
/**
 ...
 */
fun main() {
    val jsonConfigFile = getnasnetmobileJSONConfigFile()
    ...
    model.use {
        ...
        val hdfFile = getnasnetmobileWeightsFile()
...
private fun getnasnetmobileJSONConfigFile(): File {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val nasnetmobileJSONModelPath = properties["nasnetmobileJSONModelPath"] as String

    return File(nasnetmobileJSONModelPath)
}

/** Returns .h5 file with model weights, saved from Keras 2.x. */
private fun getnasnetmobileWeightsFile(): HdfFile {
    val properties = Properties()
    val reader = FileReader("data.properties")
    properties.load(reader)

    val nasnetmobileh5WeightsPath = properties["nasnetmobileh5WeightsPath"] as String

    return HdfFile(File(nasnetmobileh5WeightsPath))
}
