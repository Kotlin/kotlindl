...
/**
This example shows how to do image classification from scratch using pre-made [resnet101v2Light] model, without leveraging pre-trained weights.
...
/** */
fun main(): Unit = resnet101v2onDogsVsCatsDataset()
