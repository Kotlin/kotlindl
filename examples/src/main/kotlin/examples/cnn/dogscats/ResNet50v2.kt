...
import org.jetbrains.kotlinx.dl.api.core.model.resnet50v2Light
...
/**
This example shows how to do image classification from scratch using pre-made [resnet50v2Light] model, without leveraging pre-trained weights.
...
fun resnet50v2onDogsVsCatsDataset() {
    ...
    resnet50v2Light(imageSize = IMAGE_SIZE, numberOfClasses = NUM_CLASSES).use {
        it.compile(
            optimizer = Adam(),
...
/** */
fun main(): Unit = resnet50v2onDogsVsCatsDataset()
