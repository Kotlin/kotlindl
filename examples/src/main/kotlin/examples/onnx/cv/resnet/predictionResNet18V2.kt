...
/**
 * This examples demonstrates the inference concept on ResNet'18v2 model:
 * - Model configuration, model weights and labels are obtained from [ONNXModelHub].
 * - Model predicts on a few images located in resources.
 * - Special preprocessing (used in ResNet'18v2 during training on ImageNet dataset) is applied to images before prediction.
 */
fun resnet18v2prediction() {
    val modelHub = ONNXModelHub(cacheDirectory = File("cache/pretrainedModels"))
    val modelType = ONNXModels.CV.ResNet_18_v2
...
/** */
fun main(): Unit = resnet18v2prediction()
