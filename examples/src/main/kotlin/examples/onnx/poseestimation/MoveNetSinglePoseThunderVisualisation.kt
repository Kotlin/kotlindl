...
package examples.onnx.poseestimation
...
import org.jetbrains.kotlinx.dl.visualization.swing.drawRawPosePoints
import java.io.File
...
fun visualisationPoseNetThunder() {
    ...
    model.use {
        ...
        val imageFile = getFileFromResource("datasets/poses/1.jpg")
        ...
        visualisePosePoints(imageFile, (yhat as List<Array<Array<Array<FloatArray>>>>)[0][0][0])
...
fun visualisePosePoints(
    imageFile: File,
    posepoints: Array<FloatArray>
) {
    val preprocessing: Preprocessing = preprocess {
        load {
            pathToData = imageFile
    ...
    drawRawPosePoints(rawImage, ImageShape(256, 256, 3), posepoints)
}
