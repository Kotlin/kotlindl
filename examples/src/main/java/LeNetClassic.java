...
public class LeNetClassic {
    ...
    public static void main(String[] args) {
        ...
        try (Sequential lenet5Classic = Sequential.of(
                ...
                new Flatten(), // 3136
                new Dense(120, Activations.Tanh, new GlorotNormal(SEED), new Constant(0.1f), null, null, null, true, "dense_1", true),
                new Dense(84, Activations.Tanh, new GlorotNormal(SEED), new Constant(0.1f), null, null, null, true, "dense_2", true),
                new Dense(MnistUtilKt.NUMBER_OF_CLASSES, Activations.Linear, new GlorotNormal(SEED), new Constant(0.1f), new L2(0.001f), new L1(0.0001f), null, true, "dense_3", true)
        )) {
