...
[Quick Start Guide](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/quick_start_guide.ipynb).
...
- [Quick Start Guide](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/quick_start_guide.ipynb) 
- [Creating your first neural network](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/create_your_first_nn.ipynb)
- [Training a model](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/training_a_model.ipynb)
- [Running inference with a trained model](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/loading_trained_model_for_inference.ipynb)
- [Importing a Keras model](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/importing_keras_model.ipynb) 
- [Transfer learning](https://nbviewer.jupyter.org/github/avan1235/KotlinDL/blob/master/docs/transfer_learning.ipynb)
